#   Usage:  args = output_dir colorbar_name frame axes_fixed show_colorbar scalar_name [xmin xmax ymin ymax]
...
class Vis():
    def __init__(self, output_dir, current_frame,axes_fixed,colorbar_name,show_colorbar,scalar_name,plot_xmin,plot_xmax,plot_ymin,plot_ymax):
        ...
        png_filename = Path(self.output_dir,'cdf.png')
        ...
        plt.show()  # rwh: comment out if doing beta/montage_monolayer.py
    ...
    def plot_cell_scalar(self, frame):
        ...
        self.title_str += ": CDF " + cell_scalar_mcds_name + " ("+ str(num_cells) + " agents)"
        ...
        # self.ax0.hist(cell_scalar, edgecolor='black' )  
        # self.ax0.hist(cell_scalar, edgecolor='black',density=True )  # ,density=True
        counts1, bin_edges1 = np.histogram(cell_scalar, bins=50, density=True)
...
def main():
    ...
    #   print("Usage:  args = output_dir colorbar_name frame axes_fixed show_colorbar scalar_name [xmin xmax ymin ymax]")
